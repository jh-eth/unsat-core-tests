...
(check-sat)
; unknown
; ---------- FUNCTION int_inhale_body----------
(declare-fun x@0@00 () Int)
(declare-fun y@1@00 () Int)
(declare-fun z@2@00 () Int)
...
; [eval] x > 0
(assert (! (> x@0@00 0) :named assumption_4))
(assert (! (= ($Snap.second s@$) $Snap.unit) :named assumption_5))
; [eval] y < 10
(assert (! (< y@1@00 10) :named assumption_6))
(pop) ; 1
...
(assert (! (=> $$analysisLabel$$@6@00 (> x@0@00 0)) :named assumption_16))
(assert (! (=> $$analysisLabel$$@7@00 (= ($Snap.second s@$) $Snap.unit)) :named assumption_17))
(assert (! (=> $$analysisLabel$$@8@00 (< y@1@00 10)) :named assumption_18))
; State saturation: after contract
(set-option :rlimit 500000)
(check-sat)
; unknown
(assert (! (= result@3@00 x@0@00) :named assumption_19))
(pop) ; 1
(assert (! (forall ((s@$ $Snap) (x@0@00 Int) (y@1@00 Int) (z@2@00 Int)) (!
  (=>
