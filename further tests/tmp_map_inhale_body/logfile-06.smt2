(get-info :version)
; (:version "4.8.12")
; Started: 2026-08-26 14:37:10
; Silicon.version: 1.1-SNAPSHOT (b40ab96f+@hollensteinj/path-sensitive_analysis)
; Input file: /workspaces/develop/precision_tests/further_test_successful_used_preconditions/fp_func_map_inhale_body.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(declare-fun used_unused_map_inhale ($Snap Map<Int~_Int> Map<Int~_Int> Map<Int~_Int>) Int)
(declare-fun used_unused_map_inhale%limited ($Snap Map<Int~_Int> Map<Int~_Int> Map<Int~_Int>) Int)
(declare-fun used_unused_map_inhale%stateless (Map<Int~_Int> Map<Int~_Int> Map<Int~_Int>) Bool)
(declare-fun used_unused_map_inhale%precondition ($Snap Map<Int~_Int> Map<Int~_Int> Map<Int~_Int>) Bool)
...
(assert (! (forall ((m Map<Int~_Int>)) (!
  (<= 0 (Map_card m))
  :pattern ((Map_card m))
  :qid |$Map[Int,Int]_prog.Map_card_nonneg|)) :named prover_26))
(assert (! (forall ((m Map<Int~_Int>)) (!
  (= (Set_card (Map_domain m)) (Map_card m))
  :pattern ((Set_card (Map_domain m)))
  :pattern ((Map_card m))
  :qid |$Map[Int,Int]_prog.Map_domain_card|)) :named prover_27))
(assert (! (forall ((m1 Map<Int~_Int>) (m2 Map<Int~_Int>)) (!
  ...
  :qid |$Map[Int,Int]_prog.Map_disjoint_def1|)) :named prover_28))
(assert (! (forall ((m1 Map<Int~_Int>) (m2 Map<Int~_Int>)) (!
  (=>
  ...
  :pattern ((Map_disjoint m1 m2))
  :qid |$Map[Int,Int]_prog.Map_disjoint_def2|)) :named prover_29))
(assert (! (forall ((k Int)) (!
  (not (Set_in k (Map_domain (as Map_empty  Map<Int~_Int>))))
  :pattern ((Set_in k (Map_domain (as Map_empty  Map<Int~_Int>))))
  :qid |$Map[Int,Int]_prog.Map_empty_domain|)) :named prover_30))
(assert (! (forall ((m Map<Int~_Int>)) (!
  (and
  ...
  :pattern ((Map_card m))
  :qid |$Map[Int,Int]_prog.Map_card_zero|)) :named prover_31))
(assert (! (forall ((m1 Map<Int~_Int>) (m2 Map<Int~_Int>)) (!
  (=>
    (and
      (forall ((k Int)) (!
  ...
  :qid |$Map[Int,Int]_prog.Map_equal_def|)) :named prover_32))
(assert (! (forall ((m1 Map<Int~_Int>) (m2 Map<Int~_Int>)) (!
  (=> (Map_equal m1 m2) (= m1 m2))
  :pattern ((Map_equal m1 m2))
  :qid |$Map[Int,Int]_prog.Map_equal_ext|)) :named prover_33))
(assert (! (forall ((m Map<Int~_Int>) (k1 Int) (k2 Int) (v Int)) (!
  ...
  :qid |$Map[Int,Int]_prog.Map_update_domain|)) :named prover_34))
(assert (! (forall ((m Map<Int~_Int>) (k Int) (v Int)) (!
  ...
  :qid |$Map[Int,Int]_prog.Map_update_card|)) :named prover_35))
(assert (! (forall ((m Map<Int~_Int>) (v Int)) (!
  ...
  :qid |$Map[Int,Int]_prog.Map_values_contains|)) :named prover_36))
(assert (! (forall ((m Map<Int~_Int>) (k Int)) (!
  ...
  :qid |$Map[Int,Int]_prog.Map_values_nonempty|)) :named prover_37))
(assert (! (forall ((m Map<Int~_Int>) (k Int)) (!
  (=> (Set_in k (Map_domain m)) (Set_in (Map_apply m k) (Map_values m)))
  :pattern ((Map_apply m k))
  :qid |$Map[Int,Int]_prog.Map_values_contains|)) :named prover_38))
; End preamble
; ------------------------------------------------------------
...
; Declaring symbols related to program functions (from verification)
(assert (! (forall ((s@$ $Snap) (m@0@00 Map<Int~_Int>) (n@1@00 Map<Int~_Int>) (o@2@00 Map<Int~_Int>)) (!
  (=
    (used_unused_map_inhale%limited s@$ m@0@00 n@1@00 o@2@00)
    (used_unused_map_inhale s@$ m@0@00 n@1@00 o@2@00))
  :pattern ((used_unused_map_inhale s@$ m@0@00 n@1@00 o@2@00))
  :qid |quant-u-0|)) :named axiom_24))
(assert (! (forall ((s@$ $Snap) (m@0@00 Map<Int~_Int>) (n@1@00 Map<Int~_Int>) (o@2@00 Map<Int~_Int>)) (!
  (used_unused_map_inhale%stateless m@0@00 n@1@00 o@2@00)
  :pattern ((used_unused_map_inhale%limited s@$ m@0@00 n@1@00 o@2@00))
  :qid |quant-u-1|)) :named axiom_25))
(assert (! (forall ((s@$ $Snap) (m@0@00 Map<Int~_Int>) (n@1@00 Map<Int~_Int>) (o@2@00 Map<Int~_Int>)) (!
  (=>
    (used_unused_map_inhale%precondition s@$ m@0@00 n@1@00 o@2@00)
    (= (used_unused_map_inhale s@$ m@0@00 n@1@00 o@2@00) (Map_apply m@0@00 1)))
  :pattern ((used_unused_map_inhale s@$ m@0@00 n@1@00 o@2@00))
...
; [exec]
; var m: Map[Int,Int]
(declare-const m@0@06 Map<Int~_Int>)
; [exec]
; var n: Map[Int,Int]
(declare-const n@1@06 Map<Int~_Int>)
; [exec]
; var o: Map[Int,Int]
(declare-const o@2@06 Map<Int~_Int>)
; [exec]
; inhale n == Map(2 := 20)
...
; [eval] n == Map(2 := 20)
; [eval] Map(2 := 20)
; [eval] Map[Int,Int]()[2 := 20]
; [eval] Map[Int,Int]()
(assert (! (Map_equal n@1@06 (Map_update (as Map_empty  Map<Int~_Int>) 2 20)) :named assumption_49))
...
(assert (! (= $t@4@06 $Snap.unit) :named assumption_50))
; [eval] n == o
(assert (! (Map_equal n@1@06 o@2@06) :named assumption_51))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
...
(assert (! (= $t@5@06 $Snap.unit) :named assumption_52))
; [eval] (1 in m)
(assert (! (Set_in 1 (Map_domain m@0@06)) :named assumption_53))
; State saturation: after inhale
(check-sat)
; unknown
; [exec]
; assert used_unused_map_inhale(m, n, o) == m[1]
; [eval] used_unused_map_inhale(m, n, o) == m[1]
; [eval] used_unused_map_inhale(m, n, o)
(set-option :rlimit 0)
(push) ; 3
(declare-const $t@6@06 Map<Int~_Int>)
(assert (! (Map_equal $t@6@06 m@0@06) :named assumption_54))
(declare-const $t@7@06 Map<Int~_Int>)
(assert (! (Map_equal $t@7@06 n@1@06) :named assumption_55))
(declare-const $t@8@06 Map<Int~_Int>)
(assert (! (Map_equal $t@8@06 o@2@06) :named assumption_56))
; [eval] (1 in m)
(push) ; 4
(assert (! (not (Set_in 1 (Map_domain $t@6@06))) :named assertion_57))
(check-sat)
; unsat
(get-unsat-core)
; unsat core: (prover_33 assumption_54 assumption_53 assertion_57)
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (! (Set_in 1 (Map_domain $t@6@06)) :named assumption_58))
; [eval] (2 in n)
(push) ; 4
(assert (! (not (Set_in 2 (Map_domain $t@7@06))) :named assertion_59))
(check-sat)
; unsat
(get-unsat-core)
; unsat core: (prover_33 prover_34 assumption_49 assumption_55 assertion_59)
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (! (Set_in 2 (Map_domain $t@7@06)) :named assumption_60))
(assert (! (used_unused_map_inhale%precondition ($Snap.combine $Snap.unit $Snap.unit) m@0@06 n@1@06 o@2@06) :named assumption_61))
(pop) ; 3
; Joined path conditions
(assert (! (and
  (Map_equal $t@6@06 m@0@06)
  (Map_equal $t@7@06 n@1@06)
  (Map_equal $t@8@06 o@2@06)
  (Set_in 1 (Map_domain $t@6@06))
  (Set_in 2 (Map_domain $t@7@06))
  (used_unused_map_inhale%precondition ($Snap.combine $Snap.unit $Snap.unit) m@0@06 n@1@06 o@2@06)) :named assumption_62))
; [eval] m[1]
(push) ; 3
(assert (! (not (Set_in 1 (Map_domain m@0@06))) :named assertion_63))
(check-sat)
; unsat
(get-unsat-core)
; unsat core: (assumption_53 assertion_63)
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(push) ; 3
(assert (! (not (=
  (used_unused_map_inhale ($Snap.combine $Snap.unit $Snap.unit) m@0@06 n@1@06 o@2@06)
  (Map_apply m@0@06 1))) :named assertion_64))
(check-sat)
; unsat
(get-unsat-core)
; unsat core: (axiom_26 assumption_62 assertion_64)
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (! (=
  (used_unused_map_inhale ($Snap.combine $Snap.unit $Snap.unit) m@0@06 n@1@06 o@2@06)
  (Map_apply m@0@06 1)) :named assumption_65))
(pop) ; 2
(pop) ; 1
