...
(check-sat)
; unknown
; ---------- FUNCTION used_unused_map_inhale----------
(declare-fun m@0@00 () Map<Int~_Int>)
(declare-fun n@1@00 () Map<Int~_Int>)
(declare-fun o@2@00 () Map<Int~_Int>)
...
; [eval] (1 in m)
(assert (! (Set_in 1 (Map_domain m@0@00)) :named assumption_4))
(assert (! (= ($Snap.second s@$) $Snap.unit) :named assumption_5))
; [eval] (2 in n)
(assert (! (Set_in 2 (Map_domain n@1@00)) :named assumption_6))
(pop) ; 1
...
(assert (! (=> $$analysisLabel$$@6@00 (Set_in 1 (Map_domain m@0@00))) :named assumption_16))
(assert (! (=> $$analysisLabel$$@7@00 (= ($Snap.second s@$) $Snap.unit)) :named assumption_17))
(assert (! (=> $$analysisLabel$$@8@00 (Set_in 2 (Map_domain n@1@00))) :named assumption_18))
...
(set-option :rlimit 0)
(push) ; 2
(assert (! (not (Set_in 1 (Map_domain m@0@00))) :named assertion_19))
(check-sat)
; unsat
(get-unsat-core)
...
(assert (! (= result@3@00 (Map_apply m@0@00 1)) :named assumption_20))
(pop) ; 1
(assert (! (forall ((s@$ $Snap) (m@0@00 Map<Int~_Int>) (n@1@00 Map<Int~_Int>) (o@2@00 Map<Int~_Int>)) (!
  (=>
