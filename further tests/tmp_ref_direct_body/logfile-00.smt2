...
(assert (! $$analysisLabel$$@3@00 :named assumption_9))
(declare-const $$analysisLabel$$@4@00 Bool)
(assert (! $$analysisLabel$$@4@00 :named assumption_10))
(declare-const $$analysisLabel$$@5@00 Bool)
(assert (! $$analysisLabel$$@5@00 :named assumption_11))
(declare-const $$analysisLabel$$@6@00 Bool)
(assert (! $$analysisLabel$$@6@00 :named assumption_12))
(declare-const $$analysisLabel$$@7@00 Bool)
(assert (! $$analysisLabel$$@7@00 :named assumption_13))
(assert (! (=>
  $$analysisLabel$$@3@00
  (= s@$ ($Snap.combine ($Snap.first s@$) ($Snap.second s@$)))) :named assumption_14))
(assert (! (=> $$analysisLabel$$@4@00 (= ($Snap.first s@$) $Snap.unit)) :named assumption_15))
(assert (! (=> $$analysisLabel$$@5@00 (not (= r@0@00 $Ref.null))) :named assumption_16))
(assert (! (=> $$analysisLabel$$@6@00 (= ($Snap.second s@$) $Snap.unit)) :named assumption_17))
(assert (! (=> $$analysisLabel$$@7@00 (not (= u@1@00 $Ref.null))) :named assumption_18))
...
(assert (! (= result@2@00 (ite (= r@0@00 $Ref.null) 0 1)) :named assumption_25))
(pop) ; 1
(assert (! (forall ((s@$ $Snap) (r@0@00 $Ref) (u@1@00 $Ref)) (!
  (=>
