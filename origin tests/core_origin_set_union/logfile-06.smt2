(get-info :version)
; (:version "4.8.12")
; Started: 2026-08-27 09:34:10
; Silicon.version: 1.1-SNAPSHOT (b40ab96f+@hollensteinj/path-sensitive_analysis)
; Input file: /workspaces/develop/precision_tests/viper_function_unused_precondition_value_origins/fp_origin_set_union.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(declare-fun unused_pre_set_union ($Snap Set<Int>) Int)
(declare-fun unused_pre_set_union%limited ($Snap Set<Int>) Int)
(declare-fun unused_pre_set_union%stateless (Set<Int>) Bool)
(declare-fun unused_pre_set_union%precondition ($Snap Set<Int>) Bool)
...
(assert (! (forall ((s@$ $Snap) (s@0@00 Set<Int>)) (!
  (= (unused_pre_set_union%limited s@$ s@0@00) (unused_pre_set_union s@$ s@0@00))
  :pattern ((unused_pre_set_union s@$ s@0@00))
  :qid |quant-u-0|)) :named axiom_13))
(assert (! (forall ((s@$ $Snap) (s@0@00 Set<Int>)) (!
  (unused_pre_set_union%stateless s@0@00)
  :pattern ((unused_pre_set_union%limited s@$ s@0@00))
  :qid |quant-u-1|)) :named axiom_14))
(assert (! (forall ((s@$ $Snap) (s@0@00 Set<Int>)) (!
  (=>
    (unused_pre_set_union%precondition s@$ s@0@00)
    (= (unused_pre_set_union s@$ s@0@00) 0))
  :pattern ((unused_pre_set_union s@$ s@0@00))
...
; [exec]
; s := (Set[Int]() union Set(1))
; [eval] (Set[Int]() union Set(1))
; [eval] Set[Int]()
; [eval] Set(1)
(declare-const s@1@06 Set<Int>)
(assert (! (= s@1@06 (Set_union (as Set_empty  Set<Int>) (Set_singleton 1))) :named assumption_37))
; [exec]
; assert unused_pre_set_union(s) == 0
; [eval] unused_pre_set_union(s) == 0
; [eval] unused_pre_set_union(s)
(push) ; 3
(declare-const $t@2@06 Set<Int>)
(assert (! (Set_equal $t@2@06 s@1@06) :named assumption_38))
; [eval] (1 in s)
(push) ; 4
(assert (! (not (Set_in 1 $t@2@06)) :named assertion_39))
(check-sat)
; unsat
(get-unsat-core)
; unsat core: (prover_3 prover_13 prover_25 assumption_37 assumption_38 assertion_39)
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (! (Set_in 1 $t@2@06) :named assumption_40))
(assert (! (unused_pre_set_union%precondition $Snap.unit s@1@06) :named assumption_41))
(pop) ; 3
; Joined path conditions
(assert (! (and
  (Set_equal $t@2@06 s@1@06)
  (Set_in 1 $t@2@06)
  (unused_pre_set_union%precondition $Snap.unit s@1@06)) :named assumption_42))
(push) ; 3
(assert (! (not (= (unused_pre_set_union $Snap.unit s@1@06) 0)) :named assertion_43))
(check-sat)
; unsat
(get-unsat-core)
...
; 0.00s
; (get-info :all-statistics)
(assert (! (= (unused_pre_set_union $Snap.unit s@1@06) 0) :named assumption_44))
(pop) ; 2
(pop) ; 1
