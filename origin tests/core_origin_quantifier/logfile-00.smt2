...
(check-sat)
; unknown
; ---------- FUNCTION unused_pre_quantifier_int----------
...
(assert (! $$analysisLabel$$@4@00 :named assumption_5))
(declare-const $$analysisLabel$$@5@00 Bool)
(assert (! $$analysisLabel$$@5@00 :named assumption_6))
(assert (! (=> $$analysisLabel$$@4@00 (= s@$ $Snap.unit)) :named assumption_7))
(assert (! (=> $$analysisLabel$$@5@00 (> x@0@00 0)) :named assumption_8))
...
(assert (! (forall ((s@$ $Snap) (x@0@00 Int)) (!
  ...
  :pattern ((unused_pre_quantifier_int s@$ x@0@00))
  :qid |quant-u-4|)) :named axiom_10))
(assert (! (forall ((s@$ $Snap) (x@0@00 Int)) (!
  true
  :pattern ((unused_pre_quantifier_int s@$ x@0@00))
  :qid |quant-u-5|)) :named axiom_11))
; ---------- FUNCTION mark----------
...
(assert (! (forall ((s@$ $Snap) (i@2@00 Int)) (!
  ...
  :qid |quant-u-2|)) :named axiom_13))
(assert (! (forall ((s@$ $Snap) (i@2@00 Int)) (!
  (mark%stateless i@2@00)
  :pattern ((mark%limited s@$ i@2@00))
  :qid |quant-u-3|)) :named axiom_14))
