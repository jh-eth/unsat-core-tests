(get-info :version)
; (:version "4.8.12")
; Started: 2026-08-27 08:51:51
; Silicon.version: 1.1-SNAPSHOT (b40ab96f+@hollensteinj/path-sensitive_analysis)
; Input file: /workspaces/develop/precision_tests/viper_function_unused_precondition_value_origins/fp_origin_method_postcondition_val.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
; [eval] x == 5
(assert (! (= x@1@05 5) :named assumption_43))
; State saturation: after contract
(set-option :rlimit 500000)
(check-sat)
; unknown
...
(assert (! (= $t@3@05 x@1@05) :named assumption_45))
; [eval] x > 0
(push) ; 4
(assert (! (not (> $t@3@05 0)) :named assertion_46))
(check-sat)
; unsat
(get-unsat-core)
; unsat core: (assumption_43 assumption_45 assertion_46)
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (! (> $t@3@05 0) :named assumption_47))
(assert (! (unused_pre_method_postcondition_int%precondition $Snap.unit x@1@05) :named assumption_48))
(pop) ; 3
; Joined path conditions
(assert (! (and
  (= $t@3@05 x@1@05)
  (> $t@3@05 0)
  (unused_pre_method_postcondition_int%precondition $Snap.unit x@1@05)) :named assumption_49))
(push) ; 3
(assert (! (not (= (unused_pre_method_postcondition_int $Snap.unit x@1@05) 0)) :named assertion_50))
(check-sat)
; unsat
(get-unsat-core)
; unsat core: (axiom_19 assumption_43 assumption_49 assertion_50)
(pop) ; 3
; 0.00s
; (get-info :all-statistics)
(assert (! (= (unused_pre_method_postcondition_int $Snap.unit x@1@05) 0) :named assumption_51))
(pop) ; 2
(pop) ; 1
