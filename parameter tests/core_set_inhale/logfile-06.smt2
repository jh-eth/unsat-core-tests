...
; [eval] (1 in s)
(assert (! (Set_in 1 s@0@06) :named assumption_38))
; State saturation: after inhale
(set-option :rlimit 200000)
(check-sat)
; unknown
; [exec]
; assert unused_set_inhale(s) == 0
; [eval] unused_set_inhale(s) == 0
; [eval] unused_set_inhale(s)
(set-option :rlimit 0)
(push) ; 3
(declare-const $t@2@06 Set<Int>)
(assert (! (Set_equal $t@2@06 s@0@06) :named assumption_39))
; [eval] (1 in s)
(push) ; 4
(assert (! (not (Set_in 1 $t@2@06)) :named assertion_40))
(check-sat)
; unsat
(get-unsat-core)
; unsat core: (prover_25 assumption_38 assumption_39 assertion_40)
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (! (Set_in 1 $t@2@06) :named assumption_41))
(assert (! (unused_set_inhale%precondition $Snap.unit s@0@06) :named assumption_42))
(pop) ; 3
; Joined path conditions
(assert (! (and
  (Set_equal $t@2@06 s@0@06)
  (Set_in 1 $t@2@06)
  (unused_set_inhale%precondition $Snap.unit s@0@06)) :named assumption_43))
(push) ; 3
(assert (! (not (= (unused_set_inhale $Snap.unit s@0@06) 0)) :named assertion_44))
(check-sat)
; unsat
(get-unsat-core)
...
; 0.00s
; (get-info :all-statistics)
(assert (! (= (unused_set_inhale $Snap.unit s@0@06) 0) :named assumption_45))
(pop) ; 2
(pop) ; 1
