(get-info :version)
; (:version "4.8.12")
; Started: 2026-08-26 14:10:09
; Silicon.version: 1.1-SNAPSHOT (b40ab96f+@hollensteinj/path-sensitive_analysis)
; Input file: /workspaces/develop/precision_tests/viper_function_unused_precondition_by_parameter_type/fp_func_set_direct.vpr
; Verifier id: 00
; ------------------------------------------------------------
; Begin preamble
; ////////// Static preamble
...
(declare-fun unused_set_direct ($Snap Set<Int>) Bool)
(declare-fun unused_set_direct%limited ($Snap Set<Int>) Bool)
(declare-fun unused_set_direct%stateless (Set<Int>) Bool)
(declare-fun unused_set_direct%precondition ($Snap Set<Int>) Bool)
...
(assert (! (forall ((s@$ $Snap) (s@0@00 Set<Int>)) (!
  (= (unused_set_direct%limited s@$ s@0@00) (unused_set_direct s@$ s@0@00))
  :pattern ((unused_set_direct s@$ s@0@00))
  :qid |quant-u-0|)) :named axiom_13))
(assert (! (forall ((s@$ $Snap) (s@0@00 Set<Int>)) (!
  (unused_set_direct%stateless s@0@00)
  :pattern ((unused_set_direct%limited s@$ s@0@00))
  :qid |quant-u-1|)) :named axiom_14))
(assert (! (forall ((s@$ $Snap) (s@0@00 Set<Int>)) (!
  (=>
    (unused_set_direct%precondition s@$ s@0@00)
    (= (unused_set_direct s@$ s@0@00) true))
  :pattern ((unused_set_direct s@$ s@0@00))
...
(assert (! (= s@1@06 (Set_singleton 1)) :named assumption_37))
; [exec]
; assert unused_set_direct(s) == true
; [eval] unused_set_direct(s) == true
; [eval] unused_set_direct(s)
(push) ; 3
...
; unsat
(get-unsat-core)
; unsat core: (prover_3 prover_25 assumption_37 assumption_38 assertion_39)
(pop) ; 4
; 0.00s
; (get-info :all-statistics)
(assert (! (Set_in 1 $t@2@06) :named assumption_40))
(assert (! (unused_set_direct%precondition $Snap.unit s@1@06) :named assumption_41))
(pop) ; 3
; Joined path conditions
(assert (! (and
  (Set_equal $t@2@06 s@1@06)
  (Set_in 1 $t@2@06)
  (unused_set_direct%precondition $Snap.unit s@1@06)) :named assumption_42))
(push) ; 3
(assert (! (not (= (unused_set_direct $Snap.unit s@1@06) true)) :named assertion_43))
(check-sat)
; unsat
(get-unsat-core)
...
; 0.00s
; (get-info :all-statistics)
(assert (! (= (unused_set_direct $Snap.unit s@1@06) true) :named assumption_44))
(pop) ; 2
(pop) ; 1
